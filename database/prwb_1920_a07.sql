...
--
-- Base de données :  `prwb_1920_xyy`
--
DROP DATABASE IF EXISTS `prwb_1920_xyy`;
CREATE DATABASE IF NOT EXISTS `prwb_1920_xyy` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `prwb_1920_xyy`;
